function [ nativeScene ] = coralColorsPBRTRemodeller( parentScene, nativeScene, mappings, names, conditionValues, conditionNumbers )
...
% rearLightCover = nativeScene.world.find('MakeNamedMaterial','name','Material.010_lights.png');
% rtbMPbrtBlessAsAreaLight(rearLightCover,nativeScene,'L','100 0 0','lType','rgb');
